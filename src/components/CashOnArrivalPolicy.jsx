...
const CashOnArrivalPolicy = ({ register, errors, agreedToPolicy, setAgreedToPolicy }) => {
  ...
  return (
    <>
      <div className="p-4 border border-gray-200 rounded-md mb-6">
        ...
        {errors.policyAgreement && <p className="text-red-500 text-sm mt-1">{errors.policyAgreement.message}</p>}
      </div>
        ...
        <div className="fixed inset-0 backdrop-blur-sm bg-white/5 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto shadow-lg">
            <div className="flex justify-between items-center p-6 border-b">
              ...
              <button onClick={() => setShowPoliciesPopup(false)} className="text-gray-500 hover:text-gray-700">
                <X size={24} />
              </button>
            </div>
            <div className="p-6">
              ...
              <ul className="list-disc pl-5 space-y-2 mb-6">
                <li>Full payment is required at check-in using cash in the local currency (INR).</li>
                <li>We do not accept foreign currency, personal checks, or traveler's checks.</li>
                <li>A valid government-issued photo ID is required at check-in.</li>
                <li>
                  A security deposit of Rs. 2000 is required at check-in, refundable upon checkout after room
                  inspection.
                </li>
              </ul>

              <h3 className="text-xl font-semibold mb-4">Reservation Guarantee</h3>
              <ul className="list-disc pl-5 space-y-2 mb-6">
                <li>Your reservation will be held until 6:00 PM on the day of arrival.</li>
                <li>For late arrivals, please notify the hotel in advance to hold your reservation.</li>
                <li>Failure to arrive without prior notice may result in cancellation of your reservation.</li>
              </ul>

              <h3 className="text-xl font-semibold mb-4">Cancellation Policy</h3>
              <ul className="list-disc pl-5 space-y-2 mb-6">
                <li>Cancellations made 48 hours or more before check-in: No penalty.</li>
                <li>Cancellations made less than 48 hours before check-in: First night's room rate may be charged.</li>
                <li>
                  No-shows: Full booking amount may be charged to the credit card provided to guarantee the reservation.
                </li>
              </ul>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>All rates are inclusive of applicable taxes and service charges.</li>
              </ul>
            </div>
